          ...
          <div className="flex items-baseline justify-between">
            ...
            <div className="flex items-center gap-4 text-xs">
              ...
              <a
                ...
                title="Generate the full ICT Third-Party Register (DORA Article 28-aligned, all vendors in one PDF). Cold cache: ~30-60s."
              >
                <PdfIcon />
                Export ICT Register (PDF)
              </a>
              <button
